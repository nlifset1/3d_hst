...
#plotting lmass vs nth nearest#
pylab.scatter(lst_mass, lst_nth, alpha=0.7)

pylab.suptitle('Log Mass vs Log Galaxy Number Density of All Redshifts', fontsize=17)
