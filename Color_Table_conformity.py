...
#creating a function for finding percentage of quiescent satellites within a radius R (kpc)#
...
#getting and calculating data for the lists#
for gal in data:
...
#splitting up quiescent percentage list into more lists based on radius#
lst_q1 = []
lst_q2 = []
lst_q3 = []
lst_q4 = []
