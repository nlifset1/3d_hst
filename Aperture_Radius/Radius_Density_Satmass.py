...
#breakdown: lst_errors [central mass bin] s [satellite mass bin]#
...
#initializing lists#
#breakdown: lst_density [central mass bin] s [satellite mass bin]#
lst_density1s1 = []
lst_density2s1 = []
lst_density3s1 = []
lst_density4s1 = []
...
#for each bin at each radius, pulling data on real density and background, subtracting, and putting it into the list#
...
#averaging the four central bins together into one because I messed up#
lst_density1 = []
lst_density2 = []
lst_density3 = []
lst_density4 = []
...
#new lists have numbers that just represent satellite mass#
...
pylab.suptitle('Galaxy Number Density per Aperture Radius Binned by Satellite Mass', fontsize=15)
